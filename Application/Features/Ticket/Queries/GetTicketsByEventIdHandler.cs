...
{
    public class GetTicketsByEventIdHandler : IRequestHandler<GetTicketsByEventIdQuery, IEnumerable<TicketResponse>>
    {
        ...
        public GetTicketsByEventIdHandler(ITicketQuery ticketQuery, ITicketSeatQuery seatQuery, ITicketSectorQuery sectorQuery)
        {
        ...
        public async Task<IEnumerable<TicketResponse>> Handle(GetTicketsByEventIdQuery request, CancellationToken cancellationToken)
        {
            var tickets = await _ticketQuery.GetTicketsByEventAndUserAsync(request.EventId, request.UserId.Value, cancellationToken);
