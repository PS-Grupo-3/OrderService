...
namespace Infrastructure.Queries
{
    public class OrderStatusQuery : IOrderStatusQuery
    {
        ...
        public async Task<OrderStatus> GetByIdAsync(int paymentStatusId, CancellationToken cancellationToken = default)
        {
            return await _context.OrderStatuses
                .FirstOrDefaultAsync(c => c.OrderStatusId == paymentStatusId, cancellationToken);
        }
    }
}
